...
namespace Toolbox.Editor
{
    ...
    public static class ToolboxEditorHandler
    {
        ...
        // GetEntityId()/EntityId. Version-guarded so older editors still compile.
#if UNITY_6000_5_OR_NEWER
        private static UnityEngine.EntityId lastCachedEditorId;
#else
...
#if UNITY_6000_5_OR_NEWER
            if (lastCachedEditor == null || lastCachedEditorId != lastCachedEditor.GetEntityId())
            {
