...
namespace Genies.Avatars.Sdk.Editor
{
...
#endif
    {
        ...
        // Unity 6000.5 replaced EndNameEditAction with AssetCreationEndAction
        // (EntityId instance IDs); version-guarded so older editors still compile.
#if UNITY_6000_5_OR_NEWER
        private sealed class CreateAssetAction : AssetCreationEndAction
        {
