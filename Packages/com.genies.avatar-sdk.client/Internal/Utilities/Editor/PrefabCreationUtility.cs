...
namespace Genies.Utilities.Editor
{
    ...
    public static class PrefabCreationUtility
    {
        ...
        // Unity 6000.5 made EndNameEditAction error-obsolete in favour of
        // AssetCreationEndAction (EntityId instance IDs, implicit int
        // conversion). Version-guarded so the package still compiles when
        // opened in older editors.
#if UNITY_6000_5_OR_NEWER
        private sealed class CreatePrefabFromSourceGuidAction : AssetCreationEndAction
        {
        ...
        private sealed class CreatePrefabFromSourceAction : AssetCreationEndAction
        {
