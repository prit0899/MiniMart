...
namespace Genies.Avatars
{
...
#endif
    {
        ...
        private readonly struct RendererBlendshape : IEquatable<RendererBlendshape>
        {
            ...
            // Unity 6000.5: GetInstanceID() is error-obsolete, replaced by
            // GetEntityId()/EntityId. Version-guarded so older editors compile.
#if UNITY_6000_5_OR_NEWER
            public bool Equals(RendererBlendshape other)
            {
                var idA = _renderer != null ? _renderer.GetEntityId() : default;
                var idB = other._renderer != null ? other._renderer.GetEntityId() : default;
                return idA == idB && _blendShapeIndex == other._blendShapeIndex;
            }
            ...
            public override int GetHashCode()
            {
                ...
                {
                    int hash = 17;
                    hash = hash * 23 + (_renderer != null ? _renderer.GetEntityId().GetHashCode() : 0);
